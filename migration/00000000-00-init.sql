-- -----------------------------------------------------------------------------
-- observed_logs: every raw log surfaced by the ingest layer.
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- decision_runs: one row per opportunity that survived detection + simulation.
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- execution_attempts: one row per attempted submission, lifecycle progresses
-- from `built` -> `submitted` -> `included | reverted | dropped | replaced`.
-- -----------------------------------------------------------------------------
